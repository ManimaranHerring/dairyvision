...
from .views import (
    FarmHealthMapView, FarmNDVITrendView,
    RefreshNDVIView, WeatherView,
    ActiveAlertsView, FarmIntelligenceView,
)
from .grazing_views import (
    GrazingLandViewSet, RefreshPastureView,
...
urlpatterns = [
    ...
    # Full satellite intelligence
    path('farm-intelligence/<int:farm_id>/', FarmIntelligenceView.as_view()),
    # Grazing
